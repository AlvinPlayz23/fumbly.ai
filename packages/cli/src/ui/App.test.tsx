...
// Mock fumbly-cli-core and its Config class
vi.mock('fumbly-cli-core', async (importOriginal) => {
  const actualCore =
    await importOriginal<typeof import('fumbly-cli-core')>();
