...
import { CodebaseContextService } from '../services/codebaseContextService.js';
import {
  initializeTelemetry,
...
export class Config {
  ...
  async initialize(): Promise<void> {
    ...
    // Initialize codebase context service
    this.codebaseContextService = new CodebaseContextService(this, this.targetDir);
  }
  ...
  getCodebaseContextService(): CodebaseContextService | undefined {
    return this.codebaseContextService;
  }
  ...
  async createToolRegistry(): Promise<ToolRegistry> {
    ...
    registerCoreTool(CodebaseAnalysisTool, targetDir, this);
    registerCoreTool(FileSummarizationTool, targetDir, this);
